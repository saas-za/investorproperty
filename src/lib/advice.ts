...
export const COMPLIMENTARY_NOTE =
  "This is a complimentary standalone tool built by Investor Property. No information about the property you enter is stored. The methodology and assumptions behind it are proprietary, and use of the tool is subject to the terms of use.";
